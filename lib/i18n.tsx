...
const translations = {
  en: {
    ...
    'contribution.success': 'Question submitted',
    'contribution.successDesc': 'Thank you for your contribution! A pull request has been created.',
    'contribution.error': 'Submission failed',
    'contribution.errorDesc': 'An error occurred while submitting your question. Please try again.',
  ...
  zh: {
    ...
    'contribution.success': '题目已提交',
    'contribution.successDesc': '感谢您的贡献！已创建 Pull Request。',
    'contribution.error': '提交失败',
    'contribution.errorDesc': '提交题目时发生错误，请重试。',
