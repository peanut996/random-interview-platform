...
const translations = {
  en: {
    ...
    'contribution.enhancedDescription':
      'Contribute interview questions by pasting text or providing a URL. Our AI will extract and format them for you.',
    'contribution.inputText': 'Text Input',
    'contribution.inputUrl': 'URL Input',
    'contribution.textPlaceholder': 'Paste interview questions text here...',
    'contribution.urlPlaceholder': 'Enter a URL containing interview questions...',
    'contribution.textHint': 'Paste content with interview questions for AI to extract',
    'contribution.urlHint': 'Provide a URL to a webpage containing interview questions',
    'contribution.parse': 'Parse Questions',
    'contribution.parsing': 'Parsing...',
    'contribution.parsedQuestions': 'Detected Questions',
    'contribution.selected': 'Selected',
    'contribution.parse.success': 'Questions Detected',
    'contribution.parse.foundQuestions': '{count} questions found',
    'contribution.error.emptyInput': 'Please enter some text or a valid URL',
    'contribution.error.parsing': 'Error parsing questions. Please try again.',
    'contribution.error.noQuestionsSelected': 'Please select at least one question to contribute',
    'question.type': 'Type',
    'question.typeCoding': 'Coding',
    ...
    'question.addCategory': 'Add new category',
    'button.add': 'Add',
    // Category translations - Question Categories
    ...
    'category.HTML': 'HTML',
    'category.BasicConcepts': 'Basic Concepts',
    'category.Meta': 'Meta',
    'category.DOM': 'DOM',
    'category.SemanticHTML': 'Semantic HTML',
    'category.DOMManipulation': 'DOM Manipulation',
    'category.EventHandling': 'Event Handling',
    'category.Performance': 'Performance',
    'category.CSS': 'CSS',
    'category.Selectors': 'Selectors',
    'category.BoxModel': 'Box Model',
    'category.Layout': 'Layout',
    'category.TextStyling': 'Text Styling',
    'category.Positioning': 'Positioning',
    'category.Visibility': 'Visibility',
    'category.Units': 'Units',
    'category.UI': 'UI',
    'category.ZIndex': 'Z-index',
    ...
    // Category translations - Coding Categories
    'category.LeetCode': 'LeetCode',
    'category.LeetCodeHot100': 'LeetCode Hot 100',
    ...
    'category.DivideAndConquer': 'Divide and Conquer',
    'category.TwoPointers': 'Two Pointers',
    'category.SlidingWindow': 'Sliding Window',
    'category.Sorting': 'Sorting',
    'category.BubbleSort': 'Bubble Sort',
    'category.InsertionSort': 'Insertion Sort',
    'category.SelectionSort': 'Selection Sort',
    'category.MergeSort': 'Merge Sort',
    'category.QuickSort': 'Quick Sort',
    'category.Searching': 'Searching',
    'category.BinarySearch': 'Binary Search',
    'category.BitManipulation': 'Bit Manipulation',
    'category.Math': 'Math',
    'category.DesignPatterns': 'Design Patterns',
  },
  zh: {
    'app.title': '随机八股文生成器',
    ...
    'contribution.enhancedDescription':
      '通过粘贴文本或提供URL来贡献面试题目。我们的AI将为您提取和格式化它们。',
    'contribution.inputText': '文本输入',
    'contribution.inputUrl': 'URL输入',
    'contribution.textPlaceholder': '在此粘贴面试问题文本...',
    'contribution.urlPlaceholder': '输入包含面试问题的URL...',
    'contribution.textHint': '粘贴包含面试问题的内容，让AI提取',
    'contribution.urlHint': '提供包含面试问题的网页URL',
    'contribution.parse': '解析问题',
    'contribution.parsing': '解析中...',
    'contribution.parsedQuestions': '检测到的问题',
    'contribution.selected': '已选择',
    'contribution.parse.success': '检测到问题',
    'contribution.parse.foundQuestions': '找到{count}个问题',
    'contribution.error.emptyInput': '请输入一些文本或有效的URL',
    'contribution.error.parsing': '解析问题时出错。请重试。',
    'contribution.error.noQuestionsSelected': '请至少选择一个问题进行贡献',
    'question.type': '类型',
    'question.typeCoding': '编程',
    'question.typeQuestion': '问答',
    'question.difficulty': '难度',
    'question.category': '分类',
    'difficulty.easy': '简单',
    'difficulty.medium': '中等',
    'difficulty.hard': '困难',
    'question.addCategory': '添加新分类',
    'button.add': '添加',

    // Category translations - Question Categories
    'category.Algorithms': '算法',
    'category.TCP': 'TCP',
    'category.UDP': 'UDP',
    'category.IP': 'IP',
    'category.Spring': 'Spring',
    ...
    'category.HTML': 'HTML',
    'category.BasicConcepts': '基础概念',
    'category.Meta': 'Meta',
    'category.DOM': 'DOM',
    'category.SemanticHTML': '语义化HTML',
    'category.DOMManipulation': 'DOM操作',
    'category.EventHandling': '事件处理',
    'category.Performance': '性能',
    'category.CSS': 'CSS',
    'category.Selectors': '选择器',
    'category.BoxModel': '盒模型',
    'category.Layout': '布局',
    'category.TextStyling': '文本样式',
    'category.Positioning': '定位',
    'category.Visibility': '可见性',
    'category.Units': '单位',
    'category.UI': 'UI',
    'category.ZIndex': 'Z-index',
    ...
    // Category translations - Coding Categories
    'category.LeetCode': 'LeetCode',
    'category.LeetCodeHot100': 'LeetCode热题100',
    'category.Array': '数组',
    'category.String': '字符串',
    'category.LinkedList': '链表',
    'category.Stack': '栈',
    'category.Queue': '队列',
    'category.Tree': '树',
    'category.Graph': '图',
    'category.Heap': '堆',
    'category.HashTable': '哈希表',
    'category.Recursion': '递归',
    'category.DynamicProgramming': '动态规划',
    'category.Greedy': '贪心算法',
    'category.Backtracking': '回溯',
    'category.DivideAndConquer': '分治法',
    'category.TwoPointers': '双指针',
    'category.SlidingWindow': '滑动窗口',
    'category.Sorting': '排序',
    'category.BubbleSort': '冒泡排序',
    'category.InsertionSort': '插入排序',
    'category.SelectionSort': '选择排序',
    'category.MergeSort': '归并排序',
    'category.QuickSort': '快速排序',
    'category.Searching': '搜索',
    'category.BinarySearch': '二分查找',
    'category.BitManipulation': '位运算',
    'category.Math': '数学',
    'category.DesignPatterns': '设计模式',
  },
};
