...
export default function SettingsModal({ language, onClose }: SettingsModalProps) {
  ...
  const allOpenAIFieldsFilled = openAISettings.endpoint && openAISettings.model && openAISettings.token
          ...
          <Tabs defaultValue="questions" onValueChange={setActiveTab}>
            ...
            <TabsContent value="openai" className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label>{t("settings.endpoint")} <span className="text-red-500">*</span></Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{t("settings.model")} <span className="text-red-500">*</span></Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label>{t("settings.token")} <span className="text-red-500">*</span></Label>
                  <Input
                    type="password"
                    placeholder="sk-..."
